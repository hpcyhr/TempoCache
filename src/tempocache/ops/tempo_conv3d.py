...
class TempoConv3d(TempoBaseHDO):
    """Tempo-cached Conv3d HDO."""

    def __init__(self, conv: nn.Conv3d, runtime_config: RuntimeConfig, module_name: str = "tempo_conv3d") -> None:
        super().__init__(
            runtime_config=runtime_config,
            operator_family="conv3d",
    ...
    @classmethod
    def from_conv(cls, conv: nn.Conv3d, runtime_config: RuntimeConfig, module_name: str = "tempo_conv3d") -> "TempoConv3d":
