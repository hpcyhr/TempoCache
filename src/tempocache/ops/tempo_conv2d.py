...
class TempoConv2d(TempoBaseHDO):
    """Tempo-cached Conv2d HDO."""

    def __init__(self, conv: nn.Conv2d, runtime_config: RuntimeConfig, module_name: str = "tempo_conv2d") -> None:
        super().__init__(
            runtime_config=runtime_config,
            operator_family="conv2d",
    ...
    @classmethod
    def from_conv(cls, conv: nn.Conv2d, runtime_config: RuntimeConfig, module_name: str = "tempo_conv2d") -> "TempoConv2d":
